...
ValueNotifier<Color> _shadedColor = ValueNotifier(Colors.transparent);

Color get currentColor => _currentColor;
ValueNotifier<Color> get shadedColor => _shadedColor;

class CustomColorPicker extends StatefulWidget {
  final double width;
  const CustomColorPicker(this.width, {super.key});
  @override
...
class _CustomColorPickerState extends State<CustomColorPicker> {
  ...
  initState() {
    ...
    _shadedColor.value = _calculateShadedColor(_shadeSliderPosition);
  }
  ...
  _shadeChangeHandler(double position) {
    ...
    setState(() {
      ...
      _shadedColor.value = _calculateShadedColor(_shadeSliderPosition);
      print(
          "r: ${_shadedColor.value.red}, g: ${_shadedColor.value.green}, b: ${_shadedColor.value.blue}");
    });
  }
  ...
  Color _calculateShadedColor(double position) {
    ...
    if (ratio > 0.5) {
      ...
      print("shaded color: $_currentColor");
  ...
  Color _calculateSelectedColor(double position) {
    ...
    if (remainder == 0.0) {
      ...
      print("current color: $_currentColor");
    }
    return _currentColor;
  }
